...
/**
 * @file PainterTvg.h
 * @brief ThorVG/LVGL back end for the PainterLike concept.
 *
...
class PainterTvg {
public:
    explicit PainterTvg(lv_layer_t *pLayer) : m_pLayer(pLayer), m_dsc(pLayer) {}
    ...
    { m_path.append_circle(fCX, fCY, fR, fR); }
