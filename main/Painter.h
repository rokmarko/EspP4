...
/**
 * @file Painter.h
 * @brief The drawing back end scale::Scale is written against.
 *
 ...
 */
template<typename P>
concept PainterLike = requires(P &p, const P &cp, ::gui::ARGB argb, float f,
                               const style::Font &font, const char *psz)
{
