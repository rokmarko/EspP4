...
// QPainter back end for the PainterLike concept.
//
...
public:
	...
	void AppendCircle(float fCX, float fCY, float fR) { m_path.addEllipse(QPointF(fCX, fCY), fR, fR); }
	...
	// Place the centre of the text box at (fCX, fCY), in white.
	//
